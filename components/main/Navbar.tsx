      ...
      <div className="w-full flex items-center justify-between px-4 md:px-10 py-3">
        ...
        <div className={`md:flex flex-col md:flex-row md:items-center md:justify-center md:mr-16 w-full md:w-auto ${isMenuOpen ? 'block' : 'hidden'}`}>
          <div className={`flex flex-col md:flex-row md:gap-5 md:items-center ${isMenuOpen ? '' : 'border border-[#7042f861] bg-[#0300145e] mr-[-27px] px-[20px] py-[10px] rounded-full'}`}>
            ...
            <Link href="https://drive.google.com/file/d/1BxURgN_fp-w6f4j-hjxtbDR_BI99tmjM/view?usp=sharing" target="_blank" rel="noreferrer noopener" className="font-bold text-white bg-purple-400 rounded-lg py-1 px-2 hover:scale-105">
              My Resume
            </Link>
          </div>
